const CONFIG = {
  ...
  TEAM_EMAIL: "isha@coloursandpatterns.in",
...
function getLeadSheet_() {
  ...
  if (!spreadsheet) {
    throw new Error("Add a SPREADSHEET_ID in CONFIG or bind this script to a Google Sheet.");
  }
...
function sendAutoReply_(submission) {
  ...
  const body = [
    ...
    "",
    "If this is urgent, you can WhatsApp us at +91 79804 36369.",
    "",
    "Regards,",
    "Colours & Patterns"
  ].join("\n");

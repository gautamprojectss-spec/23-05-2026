(() => {
  ...
  document.querySelectorAll("[data-contact-form]").forEach((form) => {
    ...
    form.addEventListener("submit", async (event) => {
      ...
      window.location.href = `mailto:isha@coloursandpatterns.in?subject=${encodeURIComponent("New project inquiry for Colours & Patterns")}&body=${encodeURIComponent(lines.join("\n"))}`;
      form.reset();
      if (submitButton) {
        submitButton.disabled = false;
        submitButton.removeAttribute("aria-busy");
